const CACHE_NAME = 'side-of-death-v3';
const APP_SHELL = [
  './',
  './index.html',
...
self.addEventListener('fetch', (event) => {
  ...
  const freshFirst = event.request.mode === 'navigate' || url.pathname.endsWith('/index.html') || url.pathname.endsWith('/manifest.webmanifest') || url.pathname.endsWith('/sw.js');
  event.respondWith(
